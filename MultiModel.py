...
def load_image_files(container_path, dimension=(60, 60)):
    image_dir = Path(container_path[3])
    ...
    return Bunch(data=flat_data,
                 ...
                 DESCR=descr)
#UNSEEN
# /home/keagan/Documents/Honours/Project/UltOutThree/mod
# /home/keagan/Documents/Honours/Project/Tasks/Test/1
# /home/keagan/Documents/Honours/Project/BothPresent/Test/1
#SEEN
# /home/keagan/Documents/Honours/Project/UltOutTwo/MakeModel/

# image_dataset = load_image_files("/home/keagan/Documents/Honours/Project/TestExtendedSources/Test/1")

# for i in range(5, 90, 5):
# pathModel = "/media/keagan/Digitide 1TB/Keagan/Alpha_OneHundredPower-ES-Experiment/Test/1"
# path = "/media/keagan/Digitide 1TB/Keagan/Beta_OneHundredPower-ES-Test/Test/1"
#
# pathModel =  "/media/keagan/Digitide 1TB/Keagan/Alpha_OneHundred-ES-Experiment/Test/1"
# path =  "/media/keagan/Digitide 1TB/Keagan/Beta_OneHundred-ES-Test/Test/1"
#
# pathModel = "/media/keagan/Digitide 1TB/Keagan/Alpha_OneHundred-Experiment/Test/1"
# path = "/media/keagan/Digitide 1TB/Keagan/Beta_OneHundred-Test/Test/1"
#
# pathModel = "/media/keagan/Digitide 1TB/Keagan/Alpha_OneHundredPower-Experiment/Test/1"
# path = "/media/keagan/Digitide 1TB/Keagan/Beta_OneHundredPower-Test/Test/1"

# pathModel = "/media/keagan/Digitide 1TB/Keagan/Alpha_OneThousand-ES-Experiment/Test/1"
# path = "/media/keagan/Digitide 1TB/Keagan/Beta_OneThousand-ES-Test/Test/1"
#
# pathModel = "/media/keagan/Digitide 1TB/Keagan/Alpha_OneThousandPower-ES-Experiment/Test/1"
# path = "/media/keagan/Digitide 1TB/Keagan/Beta_OneThousandPower-ES-Test/Test/1"

# /media/keagan/Digitide 1TB/Keagan/Alpha_OneHundredPower-Experiment/Test/1 check
# /media/keagan/Digitide 1TB/Keagan/Alpha_OneThousand-ES-Experiment/Test/1


# pathModel = "/media/keagan/Digitide 1TB/Keagan/Alpha_OneThousandExperiment/Test/1"
# pathFile = "/media/keagan/Digitide 1TB/Keagan/PFVary-ES-Experiment/Test/"

# path = "/media/keagan/Keagan HDD/Honours/PFVaryPower-ES-Experiment/Test/%d"%i
# path = "/media/keagan/Digitide 1TB/Keagan/PFVaryPower-ES-Experiment/Test/%d"%i
...
def MainMethod(paths):
    ...
    with open(paths[9] +"/Train_Accuracies.txt", 'a') as A:

        with open(paths[9]+'/Train_results.txt', 'w') as f:

            figure, axes = plt.subplots()
            # Split data, but randomly allocate to training/tesSVMt sets

            X_train, X_test, y_train, y_test = train_test_split(
                image_dataset.data, image_dataset.target, test_size=0.6,random_state=42)
            ...
            tune_param_rf =[
                                {'n_estimators': [100, 200, 300, 500, 600], 'criterion': ['gini','entropy'],'max_depth': [30, 50, 100], 'min_samples_leaf': [2, 3, 5, 7]}
            ]
            # tune_param_erf =[
            ...
            tune_param_dt =[
                { 'criterion': ['gini','entropy'], 'max_depth': [30, 50, 100], 'min_samples_leaf': [2, 3, 5, 7]}
            ]
            ...
            metrics.plot_confusion_matrix(grid, X_test, y_test, display_labels=["Non PS", "PS"], cmap=plt.cm.Blues)
            plt.title("Confusion Matrix for SVM")
            # plt.show()
            plt.savefig(paths[11] + '/CNF_SVM.png', dpi=300, bbox_inches = "tight")
            # plt.show()
            plt.close()
            ...
            print('Random Chance: ROC AUC=%.3f\n' % (ns_auc))
            print('SVM: ROC AUC=%.3f\n' % (svm_auc))

            f.write('Random Chance: ROC AUC=%.3f\n' % (ns_auc))
            f.write('SVM: ROC AUC=%.3f\n' % (svm_auc))
            ...
            # show the plot
            # plt.show()
            plt.savefig(paths[11] + '/ROC_SVM.png')
            # plt.show()
            plt.close()
            ...
            #
            plt.savefig(paths[14]+'/CNF_RF.png', dpi=300, bbox_inches = "tight")
            # plt.show()
            plt.close()
            f.write('\n')
            ...
            # show the plot
            # plt.show()
            plt.savefig(paths[14]+'/ROC_RF.png', dpi=300, bbox_inches = "tight")
            # plt.show()
            plt.close()
            ...
            # plt.show()
            plt.savefig(paths[17]+'/CNF_DT.png', dpi=300, bbox_inches = "tight")
            # plt.show()
            plt.close()
            ...
            plt.legend()
            # show the plot
            plt.savefig(paths[17] + '/ROC_DT.png', dpi=300, bbox_inches = "tight")
            # plt.show()
            plt.close()
            ...
            # plt.show()
            plt.savefig(paths[20] +'/CNF_kNN.png', dpi=300, bbox_inches = "tight")
            # plt.show()
            plt.close()
            ...
            plt.legend()
            # show the plot
            plt.savefig(paths[20]+'/ROC_kNN.png',dpi=300, bbox_inches = "tight")
            # plt.show()
            plt.close()
            ...
            figure.savefig(paths[9] + '/Collective_Train_ROC.png', dpi=300, bbox_inches="tight")
            # figure.show()
            # figure.close()
...
# MainMethod("/media/keagan/Digitide 1TB/Keagan/ZETA/X_ES_H_1_final")